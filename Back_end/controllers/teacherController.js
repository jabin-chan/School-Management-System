...
async function update(req, res) {
  ...
  await teacherModel.update(existing.teacher_id, data);
  res.json(await teacherModel.findById(existing.teacher_id));
}
...
async function remove(req, res) {
  ...
  await teacherModel.remove(existing.teacher_id);
